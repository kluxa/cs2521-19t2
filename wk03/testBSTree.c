...
static void testBSTWidth(void) {
    assert(BSTWidth(t01) ==  0);
    assert(BSTWidth(t02) ==  3);
    assert(BSTWidth(t03) ==  6);
    assert(BSTWidth(t04) ==  6);
    assert(BSTWidth(t05) ==  9);
    assert(BSTWidth(t06) == 21);
    assert(BSTWidth(t07) == 12);
    assert(BSTWidth(t08) == 15);
    assert(BSTWidth(t09) == 12);
    assert(BSTWidth(t10) == 21);
    assert(BSTWidth(t11) == 27);
